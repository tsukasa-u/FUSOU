...
pub struct Req {
    ...
    #[serde(rename = "api_selected_dict[221]")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/kcapi_main/api_req_member/get_event_selected_reward@S.log";
        ...
        let log_path = "./src/kcapi_main/api_req_member/get_event_selected_reward@Q.log";
