...
//!   <img src="https://tsukasa-u.github.io/FUSOU/struct_dependency_svg/api_start2@get_option_setting.svg" alt="KC_API_dependency(api_start2/get_option_setting)" style="max-width: 2000px;"/>
//! </div>
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/kcapi/api_start2/get_option_setting@S.log";
        simple_root_test::<Res>(target_path.clone(), pattern_str.to_string(), log_path.to_string());

        let pattern_str = "S@api_start2@get_option_setting";
        let log_path = "./src/kcapi/api_start2/get_option_setting@Q.log";
