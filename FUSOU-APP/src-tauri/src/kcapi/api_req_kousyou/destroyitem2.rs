...
//!   <img src="https://tsukasa-u.github.io/FUSOU/struct_dependency_svg/api_req_kousyou@destroyitem2.svg" alt="KC_API_dependency(api_req_kousyou/destroyitem2)" style="max-width: 2000px;"/>
//! </div>
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/kcapi/api_req_kousyou/destroyitem2@S.log";
        ...
        let log_path = "./src/kcapi/api_req_kousyou/destroyitem2@Q.log";
