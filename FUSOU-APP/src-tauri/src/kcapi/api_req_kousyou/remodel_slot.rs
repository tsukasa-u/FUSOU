...
//!   <img src="https://tsukasa-u.github.io/FUSOU/struct_dependency_svg/api_req_kousyou@remodel_slot.svg" alt="KC_API_dependency(api_req_kousyou/remodel_slot)" style="max-width: 2000px;"/>
//! </div>
