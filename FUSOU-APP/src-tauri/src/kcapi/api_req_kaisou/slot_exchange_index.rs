...
//!   <img src="https://tsukasa-u.github.io/FUSOU/struct_dependency_svg/api_req_kaisou@slot_exchange_index.svg" alt="KC_API_dependency(api_req_kaisou/slot_exchange_index)" style="max-width: 2000px;"/>
//! </div>
