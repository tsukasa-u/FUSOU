...
//!   <img src="https://tsukasa-u.github.io/FUSOU/struct_dependency_svg/api_req_combined_battle@each_battle.svg" alt="KC_API_dependency(api_req_combined_battle/each_battle)" style="max-width: 2000px;"/>
//! </div>
