...
//!   <img src="https://tsukasa-u.github.io/FUSOU/struct_dependency_svg/api_get_member@sortie_conditions.svg" alt="KC_API_dependency(api_get_member/sortie_conditions)" style="max-width: 2000px;"/>
//! </div>
