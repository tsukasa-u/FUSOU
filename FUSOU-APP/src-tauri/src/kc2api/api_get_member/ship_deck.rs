...
#[add_field(extra)]
#[register_struct(name = "api_get_member/ship_deck", path = "./tests/struct_names")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let pattern_str = "S@api_get_member@ship_deck.json";
        let log_path = "./src/kc2api/api_get_member/ship_deck.log";
