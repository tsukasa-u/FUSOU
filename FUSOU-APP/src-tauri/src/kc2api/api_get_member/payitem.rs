...
#[add_field(extra)]
#[register_struct(name = "api_get_member/payitem", path = "./tests/struct_names")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let pattern_str = "S@api_get_member@payitem.json";
        let log_path = "./src/kc2api/api_get_member/payitem.log";
