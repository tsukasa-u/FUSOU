...
#[add_field(extra)]
#[register_struct(name = "api_req_kaisou/slot_deprive", path = "./tests/struct_names")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let pattern_str = "S@api_req_kaisou@slot_deprive.json";
        let log_path: &str = "./src/kc2api/api_req_kaisou/slot_deprive.log";
