...
#[add_field(extra)]
#[register_struct(name = "api_req_hensei/preset_select", path = "./tests/struct_names")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let pattern_str = "S@api_req_hensei@preset_select.json";
        let log_path = "./src/kc2api/api_req_hensei/preset_select.log";
