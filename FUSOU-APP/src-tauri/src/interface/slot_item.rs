...
impl From<Vec<kcapi::api_get_member::require_info::ApiSlotItem>> for SlotItems {
    fn from(slot_items: Vec<kcapi::api_get_member::require_info::ApiSlotItem>) -> Self {
...
impl From<kcapi::api_get_member::require_info::ApiSlotItem> for SlotItem {
    fn from(slot_item: kcapi::api_get_member::require_info::ApiSlotItem) -> Self {
        Self {
            id: slot_item.api_id,
