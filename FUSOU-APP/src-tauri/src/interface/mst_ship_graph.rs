...
impl From<Vec<kcapi::api_start2::get_data::ApiMstShipgraph>> for MstShipGraphs {
    fn from(ship_graphs: Vec<kcapi::api_start2::get_data::ApiMstShipgraph>) -> Self {
...
impl From<kcapi::api_start2::get_data::ApiMstShipgraph> for MstShipGraph {
    fn from(ship_graph: kcapi::api_start2::get_data::ApiMstShipgraph) -> Self {
        Self {
