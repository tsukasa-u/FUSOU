...
impl From<Vec<kcapi::api_start2::get_data::ApiMstMapinfo>> for MstMapInfos {
    fn from(map_infos: Vec<kcapi::api_start2::get_data::ApiMstMapinfo>) -> Self {
...
impl From<kcapi::api_start2::get_data::ApiMstMapinfo> for MstMapInfo {
    fn from(map_info: kcapi::api_start2::get_data::ApiMstMapinfo) -> Self {
        Self {
            id: map_info.api_id,
