...
impl From<Vec<kcapi::api_start2::get_data::ApiMstShipupgrade>> for MstShipUpgrades {
    fn from(ship_upgrades: Vec<kcapi::api_start2::get_data::ApiMstShipupgrade>) -> Self {
...
impl From<kcapi::api_start2::get_data::ApiMstShipupgrade> for MstShipUpgrade {
    fn from(ship_upgrade: kcapi::api_start2::get_data::ApiMstShipupgrade) -> Self {
        Self {
