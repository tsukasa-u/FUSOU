                                                        ...
                                                        {(ship_id, ship_id_index) => (
                                                            <>
                                                                ...
                                                                <div class="flex flex-nowrap">
                                                                    <IconFleetNumber class="h-6 -mt-1 pr-1" e_flag={1} fleet_number={1} ship_number={ship_id+1} combined_flag={deck_port.combined_flag == 1}></IconFleetNumber>
                                ...
                                <For each={closing_torpedo_damage().erai.list}>
                                    {(erai, _) => (
                                        <tr class="table_hover table_active rounded">
                                            ...
                                            <td>
                                                <div class="flex flex-nowrap">
                                                    <IconFleetNumber class="h-6 -mt-1 pr-1" e_flag={1} fleet_number={1} ship_number={erai+1} combined_flag={deck_port.combined_flag == 1}></IconFleetNumber>
