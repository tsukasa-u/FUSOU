...
export function IconMaterial({item_number, ...props}: JSX.HTMLAttributes<SVGSVGElement> & MaterialProps) {

  let primary_color: string = icon_list[item_list[item_number ?? 0][1]][0];
