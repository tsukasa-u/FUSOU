...
import { global_materials, global_ships, global_nDock, global_deck_port } from './interface/port.ts';
import { Materials, DeckPorts, Ships } from './interface/port.ts';

import { MstShips, MstSlotitems } from './interface/get_data.ts';
import { global_mst_ships, global_mst_slot_items } from './interface/get_data.ts';

import { SlotItems } from './interface/require_info.ts';
import { global_slotitems } from './interface/require_info.ts';
...
import { MaterialsProvider } from './utility/provider.tsx';
