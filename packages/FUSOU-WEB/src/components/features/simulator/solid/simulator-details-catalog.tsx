  ...
  return (
    <div class="space-y-4">
      ...
      <Show when={tab() === "ship"}>
        <ShipCatalogPicker
          idPrefix="ship"
          desktopSearchId="sim-details-search-input"
          mobileSearchId="sim-details-search-input-mobile"
          ships={allShips()}
          selectedShipId={selectedShipId()}
          onSelectShip={(id) => setSelectedShipId(id)}
          mobileDisplayMode={mobilePickerDisplayMode()}
          contentClass="min-w-0 space-y-2"
        >
          <Show
            when={selectedShip()}
            fallback={
