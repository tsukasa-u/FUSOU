...
export const GET = async ({ request, locals }: any) => app.fetch(request, injectEnv(locals));
export const POST = async ({ request, locals }: any) => app.fetch(request, injectEnv(locals));
export const PUT = async ({ request, locals }: any) => app.fetch(request, injectEnv(locals));
export const DELETE = async ({ request, locals }: any) => app.fetch(request, injectEnv(locals));
export const PATCH = async ({ request, locals }: any) => app.fetch(request, injectEnv(locals));
