...
export function injectEnv(locals: any): Bindings {
  ...
  return {
    ...
    URL_SHORTER_BASE: getEnv(ctx, "URL_SHORTER_BASE")!,
    // PUBLIC_SITE_URL_PRODUCTION: getEnv(ctx, "PUBLIC_SITE_URL_PRODUCTION")!,
    // PUBLIC_SITE_PREVIEW_BASE_DOMAIN: getEnv(
    //   ctx,
    //   "PUBLIC_SITE_PREVIEW_BASE_DOMAIN",
    // )!,
    // PUBLIC_SITE_URL_FALLBACK: getEnv(ctx, "PUBLIC_SITE_URL_FALLBACK")!,
