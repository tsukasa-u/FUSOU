import { DestructionBattleComponent } from "../../../components/battles/cell_events/destruction_battle.tsx";
import {
  DeckBattlesContext,
  ShipsContext,
  MstShipsContext,
...
export default {
  title: "components/battles/cell_events/destruction_battle",
  component: DestructionBattleComponent,
  tags: ["autodocs"],
  args: {
    cell_index: 2,
