import { OpeningAntiSubmarineComponent } from "../../../components/battles/battle/opening_anti_submarine.tsx";
import {
  DeckBattlesContext,
  ShipsContext,
  MstShipsContext,
...
export default {
  title: "components/battles/battle/opening_anti_submarine",
  component: OpeningAntiSubmarineComponent,
  tags: ["autodocs"],
  args: {
    battle_index: 1,
