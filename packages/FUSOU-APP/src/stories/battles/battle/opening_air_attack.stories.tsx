import { OpeningAirAttackComponent } from "../../../components/battles/battle/opening_air_attack.tsx";
import {
  DeckBattlesContext,
  ShipsContext,
  MstShipsContext,
...
export default {
  title: "components/battles/battle/opening_air_attack",
  component: OpeningAirAttackComponent,
  tags: ["autodocs"],
  args: {
    battle_index: 1,
    attack_index: 0,
