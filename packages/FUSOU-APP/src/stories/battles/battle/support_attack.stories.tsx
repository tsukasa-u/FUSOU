import { SupportAttackComponent } from "../../../components/battles/battle/support_attack.tsx";
import {
  DeckBattlesContext,
  ShipsContext,
  MstShipsContext,
...
export default {
  title: "components/battles/battle/support_attack",
  component: SupportAttackComponent,
  tags: ["autodocs"],
  args: {
    battle_index: 6,
