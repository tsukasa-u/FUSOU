import { MidnightShellingComponent } from "../../../components/battles/battle/midnight_battle.tsx";
import {
  DeckBattlesContext,
  ShipsContext,
  MstShipsContext,
...
export default {
  title: "components/battles/battle/midnight_battle",
  component: MidnightShellingComponent,
  tags: ["autodocs"],
  args: {
    battle_index: 2,
