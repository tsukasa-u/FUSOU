import { AirBaseAirAttackComponent } from "../../../components/battles/battle/air_base_air_attack.tsx";
import {
  DeckBattlesContext,
  ShipsContext,
  MstShipsContext,
...
export default {
  title: "components/battles/battle/air_base_air_attack",
  component: AirBaseAirAttackComponent,
  tags: ["autodocs"],
  args: {
    battle_index: 4,
