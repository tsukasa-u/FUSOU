...
export function MstEquipmentComponent(props: EquipmentProps) {
    ...
    <>
      <div
        ...
        onClick={() => {
          ...
          show_modal(props.equip_id);
        }}
      >
        <IconEquipment
          class="h-5 w-5 -mt-0.5"
          category_number={
            mst_slot_items.mst_slot_items[props.equip_id]._type[1]
          }
          icon_number={mst_slot_items.mst_slot_items[props.equip_id]._type[3]}
        />
        {(props.compact ?? true) ? (
          <></>
        ) : props.name_flag ? (
          <div class="pl-3 truncate">
            {mst_slot_items.mst_slot_items[props.equip_id].name ?? "Unknown"}
          </div>
        ) : (
      ...
      <Show when={show_dialog()}>
        <dialog id={"deck_equipment_modal_" + props.equip_id} class="modal">
            ...
            <div class="flex justify-start">
              <h3 class="font-bold text-base pl-3 truncate">
                {(props.name_flag ?? false)
                  ? (mst_slot_items.mst_slot_items[props.equip_id].name ??
                    "Unknown")
                  : "Unknown"}
              </h3>
            </div>
              ...
              <table class="table table-sm">
                ...
                <tbody>
                  <tr class="flex table_active table_hover rounded">
                    ...
                    <td class="flex-none w-24">
                      {props.equip_id != 0 && (props.show_param ?? false)
                        ? signed_number(
                            mst_slot_items.mst_slot_items[props.equip_id]
                              .houg ?? 0,
                          )
                        : "unknown"}
                    </td>
