...
const get_primary_color = (icon_number: number) => icon_list[icon_number ?? 0]?.[0] ?? "#FFFFFF";
const get_secondary_color = (icon_number: number) => icon_list[icon_number ?? 0]?.[1] ?? "#FFFFFF";
...
export const IconEquipment: Component<IconEquipmentProps> = (props) => {
  ...
  return (
    <svg
      ...
      overflow="hidden"
      class={["cursor-inherit", class_size[size()]].join(" ")}
    >
      <Show when={!props.empty_flag}>
        <text
          style={{
        ...
        >
          {category_list[props.category_number]}
        </text>
        <path
        ...
        <path
          ...
          stroke={get_primary_color(props.icon_number)}
          stroke-width="16"
        />
        <path
          d="M76.0 124.0 124.0 124.0Z"
          stroke={get_secondary_color(props.icon_number)}
          stroke-width="16"
        />
        {bg_slash}
      </Show>
