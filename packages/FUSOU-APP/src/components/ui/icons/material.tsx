...
const get_primary_color = (item_number: number) => {
  return icon_list[item_list[item_number ?? 0]?.[1] ?? 0]?.[0] ?? "#FFFFFF";
};
...
export const IconMaterial: Component<IconMaterialProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M28 124 124 124"
        stroke={get_primary_color(props.item_number)}
        stroke-width="16"
        stroke-miterlimit="8"
        fill="none"
        fill-rule="evenodd"
