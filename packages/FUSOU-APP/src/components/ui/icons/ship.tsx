...
export const IconShip: Component<IconShipProps> = (props) => {
  const size = () => props.size ?? "xs";
  const name = () => name_list[props.ship_stype ?? 0] ?? "UN";
  const primary_color = icon_list[""];
  const secondary_color = () => get_secondary_color(props.color ?? "");
