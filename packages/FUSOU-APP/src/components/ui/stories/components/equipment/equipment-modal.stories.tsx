import { ComponentEquipmentModalProps, ComponentEquipmentModal } from "ui";
...
export const basic: Story = {
  ...
  argTypes: {
    ...
    attr_onslot: { control: { type: "range", min: 0, max: 30, step: 1 } },
    size: {
      control: { type: "select" },
      options: size_list,
      table: {
