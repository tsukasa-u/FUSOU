...
pub struct Req {
    ...
    #[serde(rename = "api_src_idx")]
    pub api_src_idx: String,
    #[serde(rename = "api_dst_idx")]
    pub api_dst_idx: String,
    #[serde(rename = "api_id")]
    pub api_id: String,
}
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/kcapi_main/api_req_kaisou/slot_exchange_index@S.log";
        ...
        let log_path = "./src/kcapi_main/api_req_kaisou/slot_exchange_index@Q.log";
