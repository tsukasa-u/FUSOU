...
#[register_struct(name = "api_req_mission/start")]
...
#[serde(rename_all = "camelCase")]
pub struct ApiData {
    #[serde(rename = "api_complatetime")]
    pub api_complatetime: i64,
    #[serde(rename = "api_complatetime_str")]
    pub api_complatetime_str: String,
}
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_req_mission/start@S.log";
        ...
        let pattern_str = "Q@api_req_mission@start";
        let log_path = "./src/endpoints/api_req_mission/start@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_mission@start";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_mission/start@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_mission/start@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
