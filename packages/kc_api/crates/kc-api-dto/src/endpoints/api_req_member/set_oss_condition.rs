...
#![doc = register_trait::insert_svg!(path="../../tests/struct_dependency_svg/api_req_member@set_oss_condition.svg", id="kc-dependency-svg-embed", style="border: 1px solid black; height:80vh; width:100%", role="img", aria_label="KC_API_dependency(api_req_member/set_oss_condition)")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_req_member/set_oss_condition@S.log";
        ...
        let log_path = "./src/endpoints/api_req_member/set_oss_condition@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_member@set_oss_condition";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_member/set_oss_condition@snap_data@S.log";
