...
pub struct Req {
    ...
    #[qs(rename = "api_verno")]
    pub api_verno: i64,
    #[qs(rename = "api_request_flag")]
    pub api_request_flag: i64,
    #[qs(rename = "api_request_type")]
    pub api_request_type: i64,
}
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_req_member/set_friendly_request@S.log";
        ...
        let pattern_str = "Q@api_req_member@set_friendly_request";
        let log_path = "./src/endpoints/api_req_member/set_friendly_request@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_member@set_friendly_request";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_member/set_friendly_request@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_member/set_friendly_request@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
