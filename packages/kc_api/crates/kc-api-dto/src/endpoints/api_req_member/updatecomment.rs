...
#![doc = register_trait::insert_svg!(path="../../tests/struct_dependency_svg/api_req_member@updatecomment.svg", id="kc-dependency-svg-embed", style="border: 1px solid black; height:80vh; width:100%", role="img", aria_label="KC_API_dependency(api_req_member/updatecomment)")]
...
#[register_struct(name = "api_req_member/updatecomment")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let pattern_str = "S@api_req_member@updatecomment";
        let log_path = "./src/endpoints/api_req_member/updatecomment@S.log";
        ...
        let pattern_str = "Q@api_req_member@updatecomment";
        let log_path = "./src/endpoints/api_req_member/updatecomment@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let mask_patterns = vec![r"req\.api_cmt_id", r"req\.api_cmt"];
