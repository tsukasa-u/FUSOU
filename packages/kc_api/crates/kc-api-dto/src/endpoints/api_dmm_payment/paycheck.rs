...
mod tests {
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_dmm_payment@paycheck";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_dmm_payment/paycheck@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_dmm_payment/paycheck@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
