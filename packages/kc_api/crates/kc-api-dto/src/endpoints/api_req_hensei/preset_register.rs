...
#![doc = register_trait::insert_svg!(path="../../tests/struct_dependency_svg/api_req_hensei@preset_register.svg", id="kc-dependency-svg-embed", style="border: 1px solid black; height:80vh; width:100%", role="img", aria_label="KC_API_dependency(api_req_hensei/preset_register)")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_req_hensei/preset_register@S.log";
        ...
        let pattern_str = "Q@api_req_hensei@preset_register";
        let log_path = "./src/endpoints/api_req_hensei/preset_register@Q.log";
