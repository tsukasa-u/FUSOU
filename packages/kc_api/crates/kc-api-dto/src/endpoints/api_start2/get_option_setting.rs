...
#[derive(Debug, Clone, PartialEq, QueryWithExtra)]
pub struct Req {
    #[qs(rename = "api_token")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_start2/get_option_setting@S.log";
        ...
        let log_path = "./src/endpoints/api_start2/get_option_setting@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let log_path = "./src/endpoints/api_start2/get_option_setting@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_start2/get_option_setting@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
