...
#![doc = register_trait::insert_svg!(path="../../tests/struct_dependency_svg/api_req_sortie@battle.svg", id="kc-dependency-svg-embed", style="border: 1px solid black; height:80vh; width:100%", role="img", aria_label="KC_API_dependency(api_req_sortie/battle)")]
...
use crate::common::common_battle::ApiFlavoInfo;
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_req_sortie/battle@S.log";
        ...
        let log_path = "./src/endpoints/api_req_sortie/battle@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_sortie@battle";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_sortie/battle@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_sortie/battle@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
