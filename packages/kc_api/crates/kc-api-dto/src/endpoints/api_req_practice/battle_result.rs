...
#![doc = register_trait::insert_svg!(path="../../tests/struct_dependency_svg/api_req_practice@battle_result.svg", id="kc-dependency-svg-embed", style="border: 1px solid black; height:80vh; width:100%", role="img", aria_label="KC_API_dependency(api_req_practice/battle_result)")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_req_practice/battle_result@S.log";
        ...
        let pattern_str = "Q@api_req_practice@battle_result";
        let log_path = "./src/endpoints/api_req_practice/battle_result@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_practice@battle_result";
        let snap_path = format!("{snap_file_path}/kcsapi");

        let mask_patterns = vec![
            r"res\.api_data\.api_enemy_info\.api_user_name",
            r"res\.api_data\.api_enemy_info\.api_deck_name",
        ];
        let log_path = "./src/endpoints/api_req_practice/battle_result@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_practice/battle_result@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
