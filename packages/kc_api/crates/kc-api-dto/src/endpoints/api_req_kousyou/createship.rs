...
pub struct Req {
    ...
    #[qs(rename = "api_item5")]
    pub api_item5: i64,
    #[qs(rename = "api_large_flag")]
    pub api_large_flag: i64,
...
mod tests {
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_kousyou@createship";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_kousyou/createship@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_kousyou/createship@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
