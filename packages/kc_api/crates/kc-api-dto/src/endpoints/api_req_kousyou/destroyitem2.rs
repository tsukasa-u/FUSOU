...
pub struct Req {
    ...
    #[qs(rename = "api_verno")]
    pub api_verno: i64,
    #[qs(rename = "api_slotitem_ids")]
    pub api_slotitem_ids: Vec<i64>,
}
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_req_kousyou/destroyitem2@S.log";
        ...
        let log_path = "./src/endpoints/api_req_kousyou/destroyitem2@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_kousyou@destroyitem2";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_kousyou/destroyitem2@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_kousyou/destroyitem2@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
