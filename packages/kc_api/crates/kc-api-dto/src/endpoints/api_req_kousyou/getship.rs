...
pub struct Req {
    ...
    #[qs(rename = "api_verno")]
    pub api_verno: i64,
    #[qs(rename = "api_kdock_id")]
    pub api_kdock_id: i64,
}
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/endpoints/api_req_kousyou/getship@S.log";
        ...
        let log_path = "./src/endpoints/api_req_kousyou/getship@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_kousyou@getship";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_kousyou/getship@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_kousyou/getship@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
