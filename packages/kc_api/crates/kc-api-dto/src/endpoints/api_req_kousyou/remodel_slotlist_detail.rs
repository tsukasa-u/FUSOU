...
#[register_struct(name = "api_req_kousyou/remodel_slotlist_detail")]
...
pub struct ApiData {
    ...
    #[serde(rename = "api_certain_buildkit")]
    pub api_certain_buildkit: i64,
    #[serde(rename = "api_certain_remodelkit")]
    pub api_certain_remodelkit: i64,
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let pattern_str = "S@api_req_kousyou@remodel_slotlist_detail";
        let log_path = "./src/endpoints/api_req_kousyou/remodel_slotlist_detail@S.log";
        ...
        let pattern_str = "Q@api_req_kousyou@remodel_slotlist_detail";
        let log_path = "./src/endpoints/api_req_kousyou/remodel_slotlist_detail@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_kousyou@remodel_slotlist_detail";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_kousyou/remodel_slotlist_detail@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_kousyou/remodel_slotlist_detail@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
