...
#![doc = register_trait::insert_svg!(path="../../tests/struct_dependency_svg/api_req_kaisou@marriage.svg", id="kc-dependency-svg-embed", style="border: 1px solid black; height:80vh; width:100%", role="img", aria_label="KC_API_dependency(api_req_kaisou/marriage)")]
...
#[register_struct(name = "api_req_kaisou/marriage")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let pattern_str = "S@api_req_kaisou@marriage";
        let log_path = "./src/endpoints/api_req_kaisou/marriage@S.log";
        ...
        let pattern_str = "Q@api_req_kaisou@marriage";
        let log_path = "./src/endpoints/api_req_kaisou/marriage@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_req_kaisou@marriage";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_req_kaisou/marriage@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_req_kaisou/marriage@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
