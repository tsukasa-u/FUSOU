...
#![doc = register_trait::insert_svg!(path="../../tests/struct_dependency_svg/api_get_member@ship2.svg", id="kc-dependency-svg-embed", style="border: 1px solid black; height:80vh; width:100%", role="img", aria_label="KC_API_dependency(api_get_member/ship2)")]
...
pub struct Req {
    ...
    pub spi_sort_order: i64,
    #[qs(rename = "api_shipid")]
    pub api_shipid: Option<i64>,
}
...
pub struct Res {
    ...
    #[serde(rename = "api_data_deck")]
    pub api_data_deck: Vec<ApiDataDeck>,
}
...
mod tests {
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_get_member@ship2";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let log_path = "./src/endpoints/api_get_member/ship2@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_get_member/ship2@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
