...
#![doc = register_trait::insert_svg!(path="../../tests/struct_dependency_svg/api_get_member@material.svg", id="kc-dependency-svg-embed", style="border: 1px solid black; height:80vh; width:100%", role="img", aria_label="KC_API_dependency(api_get_member/material)")]
...
#[register_struct(name = "api_get_member/material")]
...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let pattern_str = "S@api_get_member@material";
        let log_path = "./src/endpoints/api_get_member/material@S.log";
        ...
        let pattern_str = "Q@api_get_member@material";
        let log_path = "./src/endpoints/api_get_member/material@Q.log";
    ...
    fn test_organize_test_data() {
        ...
        let mask_patterns = vec![r"res\.api_data\.api_member_id"];
