...
mod tests {
    ...
    fn test_organize_test_data() {
        ...
        let req_and_res_pattern_str = "@api_get_member@practice";
        let snap_path = format!("{snap_file_path}/kcsapi");
        let mask_patterns = vec![
            r"res\.api_data\.api_list\.api_enemy_comment",
            r"res\.api_data\.api_list\.api_enemy_comment_id",
            r"res\.api_data\.api_list\.api_enemy_id",
            r"res\.api_data\.api_list\.api_enemy_name",
            r"res\.api_data\.api_list\.api_enemy_name_id",
        ];
        let log_path = "./src/endpoints/api_get_member/practice@snap_data@S.log";
        ...
        let log_path = "./src/endpoints/api_get_member/practice@snap_data@Q.log";
        glob_match_normalize::<Req, Res>(
            target_path.clone(),
            req_and_res_pattern_str.to_string(),
            snap_path.to_string(),
