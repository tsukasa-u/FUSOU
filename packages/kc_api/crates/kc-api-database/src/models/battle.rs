    ...
    pub fn new_ret_option(
        ...
        let new_carrier_base_assault = {
            ...
            data.clone()
                ...
                .and_then(|assult| {
                    CarrierBaseAssault::new_ret_option(
                        ts,
                        uuid,
                        assult,
                        table,
        ...
        let new_air_base_air_attacks = {
            ...
            data.clone()
                ...
                .and_then(|attacks| {
                    AirBaseAirAttackList::new_ret_option(
                        ts,
                        uuid,
                        attacks,
                        table,
        ...
        let new_opening_air_attack = {
            ...
            data.clone()
                .opening_air_attack
                .and_then(|attack| {
                    OpeningAirAttackList::new_ret_option(
                        ts,
                        uuid,
                        attack,
                        table,
            ...
            data.clone()
                ...
                .and_then(|attack| {
                    attack.support_airatack.and_then(|airattack| {
                        SupportAirattack::new_ret_option(
                            ts,
                            uuid,
                            airattack,
                            table,
