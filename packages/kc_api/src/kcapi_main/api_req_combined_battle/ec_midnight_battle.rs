...
mod tests {
    ...
    fn test_deserialize() {
        ...
        let log_path = "./src/kcapi_main/api_req_combined_battle/ec_midnight_battle@S.log";
        ...
        let log_path = "./src/kcapi_main/api_req_combined_battle/ec_midnight_battle@Q.log";
