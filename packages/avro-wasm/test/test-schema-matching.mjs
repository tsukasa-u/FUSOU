...
const schemaV04 = "{\"name\":\"EnvInfo\",\"type\":\"record\",\"fields\":[{\"name\":\"version\",\"type\":\"string\"},{\"name\":\"uuid\",\"type\":{\"type\":\"string\"}},{\"name\":\"user_env_unique\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"}]}";
// v0_5+ EnvInfo schema: 5 fields (with app_platform)
const schemaV05 = "{\"name\":\"EnvInfo\",\"type\":\"record\",\"fields\":[{\"name\":\"version\",\"type\":\"string\"},{\"name\":\"uuid\",\"type\":{\"type\":\"string\"}},{\"name\":\"user_env_unique\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"app_platform\",\"type\":[\"null\",\"string\"]}]}";
// Unknown schema (should NOT match anything)
const schemaUnknown = "{\"name\":\"EnvInfo\",\"type\":\"record\",\"fields\":[{\"name\":\"version\",\"type\":\"string\"},{\"name\":\"uuid\",\"type\":{\"type\":\"string\"}},{\"name\":\"user_env_unique\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"dummy_field\",\"type\":\"string\"}]}";
...
async function runTest() {
    ...
    console.log(`  Matched=${r1.matched}, Version=${r1.version}, TableVersion=${r1.table_version}, Table=${r1.table_name}`);
    ...
    console.log(`  Matched=${r2.matched}, Version=${r2.version}, TableVersion=${r2.table_version}, Table=${r2.table_name}`);
    ...
    console.log(`  Matched=${r3.matched}, Version=${r3.version}, TableVersion=${r3.table_version}, Table=${r3.table_name}`);
    ...
    console.log(`  Matched=${r4.matched}, Version=${r4.version}, TableVersion=${r4.table_version}`);
    ...
    console.log(`  Matched=${r6.matched}, Version=${r6.version}, TableVersion=${r6.table_version}`);
    check("Matched (canonical fallback)", r6.matched);
    check("Version=v0_4 (canonical form matches only v0_4)", r6.version === 'v0_4');
