...
async function runDebugTest() {
    ...
    for (const version of versions) {
        ...
        for (const table of tables.slice(0, 5)) { // Show first 5
    ...
    const testCases = [
        // Test 1: Exact match as expected from Rust serialization
        {
            ...
            schema: '{"name":"EnemyDeck","type":"record","fields":[{"name":"env_uuid","type":{"type":"string"}},{"name":"uuid","type":{"type":"string"}},{"name":"ship_ids","type":["null",{"type":"string"}]}]}'
        },
        // Test 2: Simplified form
        {
            name: "enemy_deck - simplified",
            schema: '{"name":"EnemyDeck","type":"record","fields":[{"name":"env_uuid","type":"string"},{"name":"uuid","type":"string"},{"name":"ship_ids","type":["null","string"]}]}'
        },
        // Test 3: Check if the error is case-related or namespace-related
        {
            name: "env_info - base test",
            schema: '{"name":"EnvInfo","type":"record","fields":[{"name":"version","type":"string"},{"name":"uuid","type":{"type":"string"}},{"name":"user_env_unique","type":"string"},{"name":"timestamp","type":"long"}]}'
        },
    ];
