...
export interface EnumAirBaseAssult {
  AirBaseAssult: any;
}
export interface EnumCarrierBaseAssault {
  CarrierBaseAssault: any;
}
export interface EnumAirBaseAirAttack {
  AirBaseAirAttack: any;
}
export interface EnumOpeningAirAttack {
  OpeningAirAttack: any;
}
export interface EnumSupportAttack {
  SupportAttack: any;
}
export interface EnumOpeningTaisen {
  OpeningTaisen: any;
}
export interface EnumOpeningRaigeki {
  OpeningRaigeki: any;
}
export interface EnumHougeki {
  Hougeki: number;
}
export interface EnumClosingRaigeki {
  ClosingRaigeki: any;
}
export interface EnumFriendlyForceAttack {
  FriendlyForceAttack: any;
}
export interface EnumMidnightHougeki {
  MidnightHougeki: any;
}

type EnumBattleType =
  | EnumAirBaseAssult
  | EnumCarrierBaseAssault
  | EnumAirBaseAirAttack
  | EnumOpeningAirAttack
  | EnumSupportAttack
  | EnumOpeningTaisen
  | EnumOpeningRaigeki
  | EnumHougeki
  | EnumClosingRaigeki
  | EnumFriendlyForceAttack
  | EnumMidnightHougeki;

export function implementsEnumAirBaseAssult(
  arg: EnumBattleType
): arg is EnumAirBaseAssult {
  return arg !== null && typeof arg === "object" && "AirBaseAssult" in arg;
}

export function implementsEnumCarrierBaseAssault(
  arg: EnumBattleType
): arg is EnumCarrierBaseAssault {
  return arg !== null && typeof arg === "object" && "CarrierBaseAssault" in arg;
}

export function implementsEnumAirBaseAirAttack(
  arg: EnumBattleType
): arg is EnumAirBaseAirAttack {
  return arg !== null && typeof arg === "object" && "AirBaseAirAttack" in arg;
}

export function implementsEnumOpeningAirAttack(
  arg: EnumBattleType
): arg is EnumOpeningAirAttack {
  return arg !== null && typeof arg === "object" && "OpeningAirAttack" in arg;
}

export function implementsEnumSupportAttack(
  arg: EnumBattleType
): arg is EnumSupportAttack {
  return arg !== null && typeof arg === "object" && "SupportAttack" in arg;
}

export function implementsEnumOpeningTaisen(
  arg: EnumBattleType
): arg is EnumOpeningTaisen {
  return arg !== null && typeof arg === "object" && "OpeningTaisen" in arg;
}

export function implementsEnumOpeningRaigeki(
  arg: EnumBattleType
): arg is EnumOpeningRaigeki {
...
export function implementsEnumClosingRaigeki(
  arg: EnumBattleType
): arg is EnumClosingRaigeki {
  return arg !== null && typeof arg === "object" && "ClosingRaigeki" in arg;
}

export function implementsEnumFriendlyForceAttack(
  arg: EnumBattleType
): arg is EnumFriendlyForceAttack {
  return (
    arg !== null && typeof arg === "object" && "FriendlyForceAttack" in arg
  );
}

export function implementsEnumMidnightHougeki(
  arg: EnumBattleType
): arg is EnumMidnightHougeki {
