---
title: API Keys
contributors: ["antigravity-ai", "tsukasa-u"]
...
2. [**API Keys**](/dashboard/api-keys) ページにアクセスします。
   - URL: `https://fusou.dev/dashboard/api-keys`
...
2. 確認ダイアログが表示されます。
   - "Are you sure you want to delete this API key? This action cannot be undone. というメッセージが表示されます。
